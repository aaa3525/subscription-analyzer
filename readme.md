# README.md with Styling for Subscription Analyzer
...
| cycle_e | Billing cycle equals | expensive |
...
1. **Register:** https://subscription-analyzer-git-main-aaa3525s-projects.vercel.app/register
2. **Login:** https://subscription-analyzer-git-main-aaa3525s-projects.vercel.app/login
3. **Add subscriptions** with cost and usage frequency
4. **Create rules** in the Rules page (e.g., "cost > 20 = expensive")
5. **View dashboard** for automatic classification and recommendations
...
[![GitHub](https://img.shields.io/badge/GitHub-aaa3525-181717?style=flat&logo=github)](https://github.com/aaa3525)
